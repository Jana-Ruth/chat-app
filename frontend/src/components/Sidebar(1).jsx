    ...
    <aside className="sidebar">
      <div className="sidebar-header">
        ...
        <div className="sidebar-header-actions">
          <button className="icon-toggle" title="Toggle theme" onClick={toggleTheme}>
            {theme === 'dark' ? '☀️' : '🌙'}
          </button>
          <button className="icon-toggle" title="Toggle sounds" onClick={toggleSounds}>
            {soundsOn ? '🔊' : '🔇'}
          </button>
        </div>
      </div>
      ...
      <div className="sidebar-user-row">
        ...
        <div className="sidebar-user-actions">
          <Link to="/feed" className="icon-toggle" title="Posts feed">🖼️</Link>
          <Link to="/settings" className="icon-toggle" title="Settings">⚙️</Link>
              ...
              <li key={u.id || u._id}>
                {groupMode ? (
                  ...
                  <div className="search-result-row">
                    ...
                    <button onClick={() => startDirectChat(u)}>Message</button>
                  </div>
                )}
              </li>
            ))}
