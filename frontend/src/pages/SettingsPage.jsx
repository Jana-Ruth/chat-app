...
import { ArrowLeft, Image, Moon, Play, Sun, Volume2 } from 'lucide-react';
    ...
    <div className="settings-page">
      ...
      <section className="settings-section">
        ...
        <div className="settings-subsection">
          ...
          <button className="secondary-btn" onClick={() => setShowBgPicker(true)}><Image size={16} /> Choose background</button>
        </div>

        <div className="settings-subsection">
          <div className="settings-subsection-row">
            <label className="settings-subsection-label"><Volume2 size={16} /> Message sounds</label>
          ...
          <div className={`sound-pack-grid ${!soundsOn ? 'disabled' : ''}`}>
            {soundPacks().map((p) => (
              ...
              >
                <span>{p.label}</span>
                <span className="sound-pack-preview-icon"><Play size={12} /></span>
              </button>
            ))}
          </div>
        </div>
